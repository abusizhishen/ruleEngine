...
var serializedLexerAtn = []uint16{
	...
	18, 3, 18, 3, 19, 6, 19, 124, 10, 19, 13, 19, 14, 19, 125, 3, 20, 3, 20,
	3, 21, 3, 21, 3, 21, 3, 22, 3, 22, 3, 22, 3, 23, 3, 23, 3, 23, 3, 24, 3,
	24, 3, 25, 3, 25, 3, 26, 3, 26, 3, 27, 3, 27, 3, 28, 3, 28, 3, 29, 6, 29,
	150, 10, 29, 13, 29, 14, 29, 151, 3, 29, 3, 29, 2, 2, 30, 3, 3, 5, 4, 7,
	5, 9, 6, 11, 7, 13, 8, 15, 9, 17, 10, 19, 11, 21, 12, 23, 13, 25, 14, 27,
	15, 29, 16, 31, 17, 33, 18, 35, 19, 37, 20, 39, 21, 41, 22, 43, 23, 45,
	24, 47, 25, 49, 26, 51, 27, 53, 28, 55, 29, 57, 30, 3, 2, 5, 3, 2, 50,
	59, 5, 2, 67, 92, 97, 97, 99, 124, 5, 2, 11, 12, 15, 15, 34, 34, 2, 157,
	...
	2, 2, 2, 17, 79, 3, 2, 2, 2, 19, 83, 3, 2, 2, 2, 21, 89, 3, 2, 2, 2, 23,
	92, 3, 2, 2, 2, 25, 95, 3, 2, 2, 2, 27, 97, 3, 2, 2, 2, 29, 100, 3, 2,
	2, 2, 31, 106, 3, 2, 2, 2, 33, 111, 3, 2, 2, 2, 35, 116, 3, 2, 2, 2, 37,
	123, 3, 2, 2, 2, 39, 127, 3, 2, 2, 2, 41, 129, 3, 2, 2, 2, 43, 132, 3,
	2, 2, 2, 45, 135, 3, 2, 2, 2, 47, 138, 3, 2, 2, 2, 49, 140, 3, 2, 2, 2,
	51, 142, 3, 2, 2, 2, 53, 144, 3, 2, 2, 2, 55, 146, 3, 2, 2, 2, 57, 149,
	...
	112, 7, 118, 2, 2, 112, 113, 7, 116, 2, 2, 113, 114, 7, 119, 2, 2, 114,
	115, 7, 103, 2, 2, 115, 34, 3, 2, 2, 2, 116, 117, 7, 104, 2, 2, 117, 118,
	7, 99, 2, 2, 118, 119, 7, 110, 2, 2, 119, 120, 7, 117, 2, 2, 120, 121,
	7, 103, 2, 2, 121, 36, 3, 2, 2, 2, 122, 124, 9, 3, 2, 2, 123, 122, 3, 2,
	2, 2, 124, 125, 3, 2, 2, 2, 125, 123, 3, 2, 2, 2, 125, 126, 3, 2, 2, 2,
	126, 38, 3, 2, 2, 2, 127, 128, 7, 64, 2, 2, 128, 40, 3, 2, 2, 2, 129, 130,
	7, 64, 2, 2, 130, 131, 7, 63, 2, 2, 131, 42, 3, 2, 2, 2, 132, 133, 7, 63,
	2, 2, 133, 134, 7, 63, 2, 2, 134, 44, 3, 2, 2, 2, 135, 136, 7, 62, 2, 2,
	136, 137, 7, 63, 2, 2, 137, 46, 3, 2, 2, 2, 138, 139, 7, 62, 2, 2, 139,
	48, 3, 2, 2, 2, 140, 141, 7, 45, 2, 2, 141, 50, 3, 2, 2, 2, 142, 143, 7,
	47, 2, 2, 143, 52, 3, 2, 2, 2, 144, 145, 7, 44, 2, 2, 145, 54, 3, 2, 2,
	2, 146, 147, 7, 49, 2, 2, 147, 56, 3, 2, 2, 2, 148, 150, 9, 4, 2, 2, 149,
	148, 3, 2, 2, 2, 150, 151, 3, 2, 2, 2, 151, 149, 3, 2, 2, 2, 151, 152,
	3, 2, 2, 2, 152, 153, 3, 2, 2, 2, 153, 154, 8, 29, 2, 2, 154, 58, 3, 2,
	2, 2, 6, 2, 81, 125, 151, 3, 8, 2, 2,
}
...
var lexerRuleNames = []string{
	...
	"GTE", "EQ", "LTE", "LT", "ADD", "SUB", "MUL", "DIV", "WS",
}
