...
var serializedLexerAtn = []uint16{
	...
	3, 3, 3, 4, 6, 4, 49, 10, 4, 13, 4, 14, 4, 50, 3, 5, 6, 5, 54, 10, 5, 13,
	5, 14, 5, 55, 3, 6, 3, 6, 3, 6, 3, 6, 3, 6, 3, 6, 3, 7, 3, 7, 3, 7, 3,
	7, 3, 8, 3, 8, 3, 8, 3, 9, 3, 9, 3, 9, 3, 9, 3, 10, 3, 10, 3, 11, 3, 11,
	3, 11, 3, 12, 3, 12, 3, 12, 3, 13, 3, 13, 3, 13, 3, 14, 3, 14, 3, 15, 3,
	15, 3, 16, 3, 16, 3, 17, 3, 17, 3, 18, 3, 18, 3, 19, 6, 19, 97, 10, 19,
	13, 19, 14, 19, 98, 3, 19, 3, 19, 3, 20, 3, 20, 3, 20, 3, 20, 3, 20, 3,
	21, 3, 21, 3, 21, 3, 21, 3, 21, 3, 21, 2, 2, 22, 3, 3, 5, 4, 7, 5, 9, 6,
	11, 7, 13, 8, 15, 9, 17, 10, 19, 11, 21, 12, 23, 13, 25, 14, 27, 15, 29,
	16, 31, 17, 33, 18, 35, 19, 37, 20, 39, 21, 41, 22, 3, 2, 5, 5, 2, 67,
	92, 97, 97, 99, 124, 3, 2, 50, 59, 5, 2, 11, 12, 15, 15, 34, 34, 2, 115,
	...
	3, 2, 2, 2, 3, 43, 3, 2, 2, 2, 5, 45, 3, 2, 2, 2, 7, 48, 3, 2, 2, 2, 9,
	53, 3, 2, 2, 2, 11, 57, 3, 2, 2, 2, 13, 63, 3, 2, 2, 2, 15, 67, 3, 2, 2,
	2, 17, 70, 3, 2, 2, 2, 19, 74, 3, 2, 2, 2, 21, 76, 3, 2, 2, 2, 23, 79,
	3, 2, 2, 2, 25, 82, 3, 2, 2, 2, 27, 85, 3, 2, 2, 2, 29, 87, 3, 2, 2, 2,
	31, 89, 3, 2, 2, 2, 33, 91, 3, 2, 2, 2, 35, 93, 3, 2, 2, 2, 37, 96, 3,
	2, 2, 2, 39, 102, 3, 2, 2, 2, 41, 107, 3, 2, 2, 2, 43, 44, 7, 42, 2, 2,
	44, 4, 3, 2, 2, 2, 45, 46, 7, 43, 2, 2, 46, 6, 3, 2, 2, 2, 47, 49, 9, 2,
	2, 2, 48, 47, 3, 2, 2, 2, 49, 50, 3, 2, 2, 2, 50, 48, 3, 2, 2, 2, 50, 51,
	3, 2, 2, 2, 51, 8, 3, 2, 2, 2, 52, 54, 9, 3, 2, 2, 53, 52, 3, 2, 2, 2,
	54, 55, 3, 2, 2, 2, 55, 53, 3, 2, 2, 2, 55, 56, 3, 2, 2, 2, 56, 10, 3,
	2, 2, 2, 57, 58, 7, 112, 2, 2, 58, 59, 7, 113, 2, 2, 59, 60, 7, 121, 2,
	2, 60, 61, 7, 42, 2, 2, 61, 62, 7, 43, 2, 2, 62, 12, 3, 2, 2, 2, 63, 64,
	7, 99, 2, 2, 64, 65, 7, 112, 2, 2, 65, 66, 7, 102, 2, 2, 66, 14, 3, 2,
	2, 2, 67, 68, 7, 113, 2, 2, 68, 69, 7, 116, 2, 2, 69, 16, 3, 2, 2, 2, 70,
	71, 7, 112, 2, 2, 71, 72, 7, 113, 2, 2, 72, 73, 7, 118, 2, 2, 73, 18, 3,
...
var lexerRuleNames = []string{
	"T__0", "T__1", "IDENTIFY", "NUM", "NOW", "AND", "OR", "NOT", "GT", "GTE",
	"EQ", "LTE", "LT", "ADD", "SUB", "MUL", "DIV", "WS", "TRUE", "FALSE",
}
